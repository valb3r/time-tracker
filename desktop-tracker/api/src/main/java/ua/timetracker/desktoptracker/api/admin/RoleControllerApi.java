...
public class RoleControllerApi {
     ...
     */
    public okhttp3.Call updateUserRolesInProjectCall(Long roleId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateUserRolesInProjectValidateBeforeCall(Long roleId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateUserRolesInProjectCall(roleId, _callback);
        return localVarCall;
     ...
     */
    public RoleDetailsDto updateUserRolesInProject(Long roleId) throws ApiException {
        ApiResponse<RoleDetailsDto> localVarResp = updateUserRolesInProjectWithHttpInfo(roleId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RoleDetailsDto> updateUserRolesInProjectWithHttpInfo(Long roleId) throws ApiException {
        okhttp3.Call localVarCall = updateUserRolesInProjectValidateBeforeCall(roleId, null);
     ...
     */
    public okhttp3.Call updateUserRolesInProjectAsync(Long roleId, final ApiCallback<RoleDetailsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateUserRolesInProjectValidateBeforeCall(roleId, _callback);
        Type localVarReturnType = new TypeToken<RoleDetailsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateUserRolesInProject1Call(Long roleId, RoleDetailsDto roleDetailsDto, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = roleDetailsDto;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateUserRolesInProject1ValidateBeforeCall(Long roleId, RoleDetailsDto roleDetailsDto, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateUserRolesInProject1Call(roleId, roleDetailsDto, _callback);
        return localVarCall;
     ...
     */
    public ProjectDto updateUserRolesInProject1(Long roleId, RoleDetailsDto roleDetailsDto) throws ApiException {
        ApiResponse<ProjectDto> localVarResp = updateUserRolesInProject1WithHttpInfo(roleId, roleDetailsDto);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectDto> updateUserRolesInProject1WithHttpInfo(Long roleId, RoleDetailsDto roleDetailsDto) throws ApiException {
        okhttp3.Call localVarCall = updateUserRolesInProject1ValidateBeforeCall(roleId, roleDetailsDto, null);
     ...
     */
    public okhttp3.Call updateUserRolesInProject1Async(Long roleId, RoleDetailsDto roleDetailsDto, final ApiCallback<ProjectDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateUserRolesInProject1ValidateBeforeCall(roleId, roleDetailsDto, _callback);
        Type localVarReturnType = new TypeToken<ProjectDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
