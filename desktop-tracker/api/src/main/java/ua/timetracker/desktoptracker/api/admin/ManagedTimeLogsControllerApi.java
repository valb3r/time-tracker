...
public class ManagedTimeLogsControllerApi {
    ...
    /**
     * Build call for timeCardsForManagedProjectsOfUsers
     * @param projectIds  (required)
     ...
     */
    public okhttp3.Call timeCardsForManagedProjectsOfUsersCall(Set<Long> projectIds, Set<Long> userIds, LocalDateTime from, LocalDateTime to, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/resources/managed/timelogs/projects/{project_ids}/users/{user_ids}"
            .replaceAll("\\{" + "project_ids" + "\\}", localVarApiClient.escapeString(localVarApiClient.collectionPathParameterToString("csv", projectIds)))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call timeCardsForManagedProjectsOfUsersValidateBeforeCall(Set<Long> projectIds, Set<Long> userIds, LocalDateTime from, LocalDateTime to, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectIds' is set
        if (projectIds == null) {
            throw new ApiException("Missing the required parameter 'projectIds' when calling timeCardsForManagedProjectsOfUsers(Async)");
        }
        
        // verify the required parameter 'userIds' is set
        if (userIds == null) {
            throw new ApiException("Missing the required parameter 'userIds' when calling timeCardsForManagedProjectsOfUsers(Async)");
        }
        

        okhttp3.Call localVarCall = timeCardsForManagedProjectsOfUsersCall(projectIds, userIds, from, to, _callback);
        return localVarCall;
     ...
     */
    public List<TimeLogDto> timeCardsForManagedProjectsOfUsers(Set<Long> projectIds, Set<Long> userIds, LocalDateTime from, LocalDateTime to) throws ApiException {
        ApiResponse<List<TimeLogDto>> localVarResp = timeCardsForManagedProjectsOfUsersWithHttpInfo(projectIds, userIds, from, to);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<TimeLogDto>> timeCardsForManagedProjectsOfUsersWithHttpInfo(Set<Long> projectIds, Set<Long> userIds, LocalDateTime from, LocalDateTime to) throws ApiException {
        okhttp3.Call localVarCall = timeCardsForManagedProjectsOfUsersValidateBeforeCall(projectIds, userIds, from, to, null);
        Type localVarReturnType = new TypeToken<List<TimeLogDto>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call timeCardsForManagedProjectsOfUsersAsync(Set<Long> projectIds, Set<Long> userIds, LocalDateTime from, LocalDateTime to, final ApiCallback<List<TimeLogDto>> _callback) throws ApiException {

        okhttp3.Call localVarCall = timeCardsForManagedProjectsOfUsersValidateBeforeCall(projectIds, userIds, from, to, _callback);
        Type localVarReturnType = new TypeToken<List<TimeLogDto>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
